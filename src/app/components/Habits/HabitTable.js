...
/*eslint-disable */
function HabitTable({ day, userData, index, successMessage, errorMessage }) {
        ...
        <Fragment>
            <Table
                ...
                columns={[
                    {
                        Header: (props) => (
                            <Header name="Name" sorted={sorted} {...props} />
                        ),
                        accessor: 'name',
            ...
            {dialog &&
                day.nutrition.meals &&
                day.nutrition.meals[mealToDelete] && (
                    <ConfirmationDialog
                        open={dialog}
...
export default connect(mapStateToProps, mapDispatchToProps)(HabitTable);
